...
const ContactFooter = () => {
  return (
    <div className="w-full bg-white">
      <div className="flex md:flex-row flex-col md:justify-between gap-y-3 justify-center items-center w-full md:mt-0 mt-8  md:pl-20 md:pr-40 md:pb-0 pb-8  h-full  m-w-[1200px] ">
