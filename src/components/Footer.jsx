...
const Footer = () => {
  return (
    <div className="w-full bg-transparent ">
      <div className="md:w-[90%] w-full flex md:flex-row flex-col md:pl-20 md:pr-5 bg-transparent md:gap-y-0 gap-y-3  h-full max-w-[1200px]  md:justify-between justify-center pt-2 pb-5">
        <div className="flex md:flex-row flex-col gap-x-8 gap-y-3 items-center">
          <h1 className="text-black md:pl-3 text-[10px] font-[800] tracking-wider">SOCIAL:</h1>
