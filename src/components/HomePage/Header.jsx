    ...
    <div className="w-full bg-white">
      <div className="w-[90%] md:pl-20 md:pr-5  h-full max-w-[1200px] md:pt-16">
        <div className="md:flex hidden flex-row justify-between items-center">
          ...
          <button className="w-[180px] h-[38px] text-left pl-5 transition-all duration-700 ease-in-out  hover:scale-95 text-[12px] leading-[14.63px] font-[600] text-white bg-black">
            HIRE US
          </button>
        </div>
      </div>
