  ...
  return (
    <div className="w-full relative ">
      <div className="flex  w-[90px]  h-[90px] absolute right-0 top-0   justify-start rotate-90 items-center z-30">
       ...
       <nav className="bg-white   md:pr-60 md:pl-20 px-0 py-[33px] ">
          <ul className="md:flex hidden lg:gap-x-14 md:gap-x-8 items-center  gap-4 md:text-[13px] text-[10px] font-[600] text-[#A4A4A4] leading-6">
            <li className="transition-all duration-700 rotate-180 ease-in-out  hover:scale-95 ">
              <NavLink to="/" className={({isActive}) => `${isActive && "text-[black]"}`}>HOMEPAGE</NavLink>
            </li>
            <li className="transition-all duration-700 rotate-180 ease-in-out  hover:scale-95 ">
              <NavLink to="/works" className={({isActive}) => `${isActive && "text-[black]"}`}>WORKS</NavLink>
            </li>
            <li className="transition-all duration-700 rotate-180 ease-in-out  hover:scale-95 ">
              <NavLink to="/services" className={({isActive}) => `${isActive && "text-[black]"}`}>SERVICES</NavLink>
            </li>
            <li className="transition-all duration-700 rotate-180 ease-in-out  hover:scale-95 ">
